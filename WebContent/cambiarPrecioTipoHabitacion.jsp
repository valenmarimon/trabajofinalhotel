   ...
   <% 
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col" >
         ...
         <h1 style="text-align: center;">Seleccionar Tipo de Habitación:</h1>
        
       <form action="ModificarPrecioTipoHabitacion" method="post" name="formRegistro" id="formRegistro" onsubmit="return validar(this)">
    ...
    <input type="submit" name="registrar" class="btn btn-lg btn-info btn-block" style="margin-top:10px" id="registrar" value="Cambiar Precio">
         ...
         <a href="admHabitaciones.jsp" class="btn btn-info btn-lg btn-block" role="button">Regresar</a>
          <a href="administrar.jsp" class="btn btn-info btn-lg btn-block" role="button">Menu Principal</a>
