    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-10 col" >
 		 ...
 		 <form action="ModificarHabitacion" method="post" name="formRegistroHab" id="formRegistro">
		
      		<label for="numero">Número: </label>
            <input type="text" id="numero" name="numero" class="form-control" value="<%= numeroStr %>">
            <label for="numero" style="color:red" id="msjNum"></label><br/>
            
            <label for="piso">piso: </label>
            <input type="text" id="piso" name="piso" class="form-control" value="<%= h.getPiso() %>">
            <label for="piso" style="color:red" id="msjPiso"></label><br/>
            
            <label for="tipo_habitacion">Tipo Habitación:</label> <br>
            
           	<% if(h.getDescripcionTipo().equals("Doble Single")){ %> 
            
			<input type="radio" id="tipo_habitacion" name="tipo_habitacion"value="1" checked=true> Doble Single 
			...
			<% if(h.getDescripcionTipo().equals("Deluxe")){ %> 
            
			<input type="radio" id="tipo_habitacion" name="tipo_habitacion"value="2" checked=true> Deluxe 
			...
			<% if(h.getDescripcionTipo().equals("Doble Deluxe")){ %> 
            
			<input type="radio" id="tipo_habitacion" name="tipo_habitacion"value="3" checked=true>Doble Deluxe 
	       ...
	       <input type="hidden" value="<%= h.getId_habitacion() %>" name="id_habitacion" id="id_habitacion">
  
            <input type="submit" name="registrar" class="btn btn-lg btn-info btn-block" style="margin-top:10px" id="registrar" value="Actualizar Habitacion">
